    ...
    <section class="py-16 pt-18">
      <div class="w-4/5 md:w-3/5 mx-auto">
        ...
        <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">
          Voici quelques-unes de nos FAQ. Si vous avez d'autres questions auxquelles vous aimeriez répondre,
...
export default {
  ...
  created() {
    this.axios.get('http://localhost:8000/api/v1/faqs/')
      .then(response => {
