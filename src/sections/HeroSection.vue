    ...
    <div class="container mx-auto px-5 overflow-x-hidden lg:overflow-x-visible">
        <section class="grid grid-cols-none lg:grid-cols-2 pb-16 pt-8 items-center">
            <div class="lg:w-5/6 order-2 lg:order-none">
                <h1 class="text-4xl xl:text-5xl font-bold font-theme-heading text-center lg:text-left">{{ $t('hero.h1') }}
                </h1>
                ...
                <div class="flex justify-center lg:justify-start mt-10">
                    <LinkButton btn-type="primary" link="#download-section">{{ $t('hero.btn1') }}</LinkButton>
                    <LinkButton btn-type="muted" link="#download-section">{{ $t('hero.btn2') }}</LinkButton>
                </div>
            </div>
