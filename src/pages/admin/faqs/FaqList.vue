    ...
    <div
        ...
        <div class="w-full mb-1">
            ...
            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                <router-link :to="{ name: 'createFaq' }" type="button"
                ...
                <div class="overflow-hidden shadow m-4">
                    <table class="w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600 ">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700 ">
                            ...
                            <tr v-for="faq in faqs" :key="faq.id" class="hover:bg-gray-100 dark:hover:bg-gray-700">

                                <td class="flex items-center p-4 mr-12 space-x-6 ">

                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                        <div
                                            class="text-base truncate font-semibold text-gray-900 dark:text-white overflow-hidden">
                                            {{ faq.title }}
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <router-link :to="{ name: 'editFaq', params: { id: faq.id } }" type="button"
...
export default {
    ...
    created() {
        ...
        this.axios.get('http://localhost:8000/api/v1/faq/')
            .then(response => {
    ...
    methods: {
        deleteFaq(id) {
            this.axios
                .delete(`http://localhost:8000/api/v1/faq/${id}`)
                .then(response => {
                    let i = this.faqs.map(data => data.id).indexOf(id);
