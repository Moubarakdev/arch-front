                    ...
                    <form @submit.prevent="updateFeature">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="">
                                    <img :src="feature.image" alt="img" srcset="">
                                </div>
                            </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="items-center py-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                            <button
                                ...
                                type="submit">Edit feature</button>
                        </div>
                    </form>
                </div>
...
export default {
    ...
    created() {
        this.axios
            .get(`http://localhost:8000/api/v1/feature/${this.$route.params.id}`)
            .then((res) => {
    ...
    methods: {
        updateFeature() {
            ...
            this.axios
                .patch(`http://localhost:8000/api/v1/feature/${this.$route.params.id}`, formData)
                .then(response => {
