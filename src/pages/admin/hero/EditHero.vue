                    ...
                    <form @submit.prevent="updateHero">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="name" id="name" v-model="hero.h1"
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea id="description" rows="4" v-model="hero.paragraph"
                            ...
                            <div class="col-span-6">
                                ...
                                <div class="">
                                    <img :src=hero.image alt="img" srcset="">
                                </div>
                            </div>
                        </div>
                        <!-- Modal footer -->
...
export default {
    ...
    created() {
        this.axios
            .get(`http://localhost:8000/api/v1/hero/${this.$route.params.id}`)
            .then((res) => {
    ...
    methods: {
        updateHero() {
            ...
            formData.append('h1', this.hero.h1);
            formData.append('paragraph', this.hero.paragraph);
            formData.append('image', this.hero.image);
            this.axios
                .patch(`http://localhost:8000/api/v1/hero/${this.$route.params.id}`, formData)
                .then((res) => {
                    this.$router.push({ name: 'heros' });
                });
        },
        onFileChange(event) {
            this.hero.image = event.target.files[0]; // Prenez le premier fichier sélectionné
        }
    },
