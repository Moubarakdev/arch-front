    ...
    <main>
      <section class="absolute w-full h-full">
        <div class="absolute top-0 w-full h-full bg-gray-900" style="background-size: 100%; background-repeat: no-repeat"
          v-bind:style="{
            'background-image':
              'url(' + import('../assets/img/register_bg_2.png') + ')',
          }"></div>
                    ...
                    <div>
                      <label class="inline-flex items-center cursor-pointer">
                        <input id="customCheckLogin" type="checkbox"
                          class="form-checkbox border-0 rounded text-theme-primary ml-1 w-5 h-5 bg-gray-300"
                          style="transition: all 0.15s ease 0s" />
                        <span class="ml-2 text-sm font-semibold text-theme-dark-blue-tp">Remember me</span></label>
                    </div>
                    <div class="text-center mt-6">
                      <button
                        class="bg-theme-secondary hover:bg-white hover:text-theme-secondary hover:border hover:border-theme-secondary text-white  text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full"
                        type="button" style="transition: all 0.15s ease 0s">
                        Sign In
                      </button>
                    </div>
